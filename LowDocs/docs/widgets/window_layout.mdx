...
It is also possible to hide and show certain widgets using the _View_ menu at the top of the screen.
Automatically the system will save which widgets are shown/hidden by the user.
Closing and reopening the editor will restore the last configuration of widgets.
