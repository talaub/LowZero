...
While the mesh is the only required property to have something being rendered to the screen, the material property can be used to assign [material](../assets/material) information to the object.