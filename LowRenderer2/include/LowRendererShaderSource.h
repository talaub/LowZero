...
namespace Low {
  namespace Renderer {
    ...
    struct LOW_RENDERER2_API ShaderSource : public Low::Util::Handle
    {
    public:
      struct Data
      {
      public:
        ...
        Low::Util::List<Low::Renderer::ShaderVariant> variants;
        Low::Util::Name name;
    ...
    public:
      ...
      static Low::Util::List<ShaderSource> ms_LivingInstances;
      ...
      ShaderSource(u64 p_Id) : Low::Util::Handle(p_Id)
      {
      }
      ShaderSource() : Low::Util::Handle()
      {
      }
      ShaderSource(Low::Util::Handle p_Handle)
      ...
      static ShaderSource *living_instances()
      {
        return ms_LivingInstances.data();
      }

      static ShaderSource create_handle_by_index(u32 p_Index);

      static ShaderSource find_by_index(uint32_t p_Index);
      ...
      ShaderSource duplicate(Low::Util::Name p_Name) const;
      static ShaderSource duplicate(ShaderSource p_Handle,
                                    Low::Util::Name p_Name);
      static Low::Util::Handle _duplicate(Low::Util::Handle p_Handle,
                                          Low::Util::Name p_Name);

      static ShaderSource find_by_name(Low::Util::Name p_Name);
      ...
      uint64_t get_last_modified() const;
      void set_last_modified(uint64_t p_Value);
