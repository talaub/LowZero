...
namespace Low {
  namespace Renderer {
    ...
    public:
      ...
      TextureStaging(u64 p_Id) : Low::Util::Handle(p_Id)
      {
      }
      TextureStaging() : Low::Util::Handle()
      {
      }
      TextureStaging(Low::Util::Handle p_Handle)
      ...
      TextureStaging &operator=(const TextureStaging &) = default;
      TextureStaging &operator=(TextureStaging &&) noexcept = default;
