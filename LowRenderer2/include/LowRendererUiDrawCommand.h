...
namespace Low {
  namespace Renderer {
    ...
    public:
      ...
      UiDrawCommand(u64 p_Id) : Low::Util::Handle(p_Id)
      {
      }
      UiDrawCommand() : Low::Util::Handle()
      {
      }
      UiDrawCommand(Low::Util::Handle p_Handle)
      ...
      UiDrawCommand &operator=(const UiDrawCommand &) = default;
      UiDrawCommand &operator=(UiDrawCommand &&) noexcept = default;
