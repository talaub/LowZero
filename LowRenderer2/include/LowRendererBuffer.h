...
namespace Low {
  namespace Renderer {
    ...
    struct LOW_RENDERER2_API Buffer : public Low::Util::Handle
    {
    public:
      struct Data
      {
    ...
    public:
      ...
      explicit Buffer(const Buffer &p_Copy)
      ...
      Buffer(u64 p_Id) : Low::Util::Handle(p_Id)
      {
      }
      Buffer() : Low::Util::Handle()
      {
      }
      Buffer(Low::Util::Handle p_Handle)
      ...
      static Buffer create_handle_by_index(u32 p_Index);
      ...
      Buffer duplicate(Low::Util::Name p_Name) const;
      static Buffer duplicate(Buffer p_Handle,
