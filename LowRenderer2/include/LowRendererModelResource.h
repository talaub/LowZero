...
namespace Low {
  namespace Renderer {
    ...
    struct LOW_RENDERER2_API ModelResource : public Low::Util::Handle
    {
    public:
      struct Data
      {
    ...
    public:
      ...
      static Low::Util::List<ModelResource> ms_LivingInstances;
    ...
    public:
      explicit ModelResource(const ModelResource &p_Copy)
      ...
      static ModelResource create_handle_by_index(u32 p_Index);

      static ModelResource find_by_index(uint32_t p_Index);
      ...
      static ModelResource find_by_name(Low::Util::Name p_Name);
