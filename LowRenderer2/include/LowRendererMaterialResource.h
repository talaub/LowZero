...
namespace Low {
  namespace Renderer {
    ...
    public:
      explicit MaterialResource(const MaterialResource &p_Copy)
      ...
      static MaterialResource create_handle_by_index(u32 p_Index);

      static MaterialResource find_by_index(uint32_t p_Index);
      ...
      static MaterialResource find_by_name(Low::Util::Name p_Name);
