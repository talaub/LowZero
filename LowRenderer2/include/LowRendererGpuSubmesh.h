...
namespace Low {
  namespace Renderer {
    ...
    public:
      ...
      GpuSubmesh(u64 p_Id) : Low::Util::Handle(p_Id)
      {
      }
      GpuSubmesh() : Low::Util::Handle()
      {
      }
      GpuSubmesh(Low::Util::Handle p_Handle)
      ...
      GpuSubmesh &operator=(const GpuSubmesh &) = default;
      GpuSubmesh &operator=(GpuSubmesh &&) noexcept = default;
