...
namespace Low {
  namespace Renderer {
    ...
    public:
      ...
      EditorImageGpu(u64 p_Id) : Low::Util::Handle(p_Id)
      {
      }
      EditorImageGpu() : Low::Util::Handle()
      {
      }
      EditorImageGpu(Low::Util::Handle p_Handle)
      ...
      EditorImageGpu &operator=(const EditorImageGpu &) = default;
      EditorImageGpu &operator=(EditorImageGpu &&) noexcept = default;
