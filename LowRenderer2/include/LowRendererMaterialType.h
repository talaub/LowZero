...
namespace Low {
  namespace Renderer {
    ...
    public:
      ...
      bool allows_highlighting() const;
      void allows_highlighting(bool p_Value);
      void toggle_allows_highlighting();
      ...
      Low::Renderer::GraphicsPipelineConfig &
      get_highlight_pipeline_config() const;
