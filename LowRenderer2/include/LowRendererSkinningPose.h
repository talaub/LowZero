...
namespace Low {
  namespace Renderer {
    ...
    struct LOW_RENDERER2_API SkinningPose : public Low::Util::Handle
    {
    public:
      struct Data
      {
    ...
    public:
      ...
      static Low::Util::List<SkinningPose> ms_LivingInstances;
      ...
      static SkinningPose make(Low::Util::Name p_Name);
      static Low::Util::Handle _make(Low::Util::Name p_Name);
      explicit SkinningPose(const SkinningPose &p_Copy)
      ...
      SkinningPose(u64 p_Id) : Low::Util::Handle(p_Id)
      {
      }
      SkinningPose() : Low::Util::Handle()
      {
      }
      SkinningPose(Low::Util::Handle p_Handle)
      ...
      SkinningPose &operator=(const SkinningPose &) = default;
      SkinningPose &operator=(SkinningPose &&) noexcept = default;

      static uint32_t living_count()
      {
        return static_cast<uint32_t>(ms_LivingInstances.size());
      }
      static SkinningPose *living_instances()
      {
        return ms_LivingInstances.data();
      }

      static SkinningPose create_handle_by_index(u32 p_Index);

      static SkinningPose find_by_index(uint32_t p_Index);
      ...
      SkinningPose duplicate(Low::Util::Name p_Name) const;
      static SkinningPose duplicate(SkinningPose p_Handle,
                                    Low::Util::Name p_Name);
      static Low::Util::Handle _duplicate(Low::Util::Handle p_Handle,
                                          Low::Util::Name p_Name);

      static SkinningPose find_by_name(Low::Util::Name p_Name);
      ...
      static void destroy(Low::Util::Handle p_Handle)
      {
        ...
        l_SkinningPose.destroy();
      }

      Util::List<Math::Matrix4x4> &get_matrices() const;

      Skeleton get_skeleton() const;
      void set_skeleton(Skeleton p_Value);
