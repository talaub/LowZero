...
namespace Low {
  namespace Renderer {
    namespace Vulkan {
      ...
      struct LOW_RENDERER2_API TexExportData
      {
        ...
        {
          return sizeof(TexExportData);
        }
      };

      struct LOW_RENDERER2_API TexExport : public Low::Util::Handle
      {
      public:
        ...
        static Low::Util::List<TexExport> ms_LivingInstances;
        ...
        static TexExport *living_instances()
        {
        ...
        static TexExport find_by_name(Low::Util::Name p_Name);
        static Low::Util::Handle
        ...
        {
          READ_LOCK(l_Lock);
          return p_Handle.get_type() == TexExport::TYPE_ID &&
        ...
        AllocatedBuffer &get_staging_buffer() const;
        void set_staging_buffer(AllocatedBuffer &p_Value);

        uint32_t get_frame_index() const;
        void set_frame_index(uint32_t p_Value);
