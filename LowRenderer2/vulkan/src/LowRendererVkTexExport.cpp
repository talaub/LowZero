...
namespace Low {
  namespace Renderer {
    namespace Vulkan {
      ...
      u16 TexExport::ms_TypeId = 0;
      const Low::Util::TypeIdentifier
          TexExport::IDENTIFIER(LOW_NAME(509652687),
                                LOW_NAME(2061076038));
      ...
      TexExport TexExport::make(Low::Util::Name p_Name)
      {
        ...
        l_Handle.m_Data.m_Type = TexExport::ms_TypeId;
      ...
      void TexExport::initialize()
      {
        ...
        l_TypeInfo.uiComponent = false;
        {
          ...
          l_PropertyInfo.size =
              sizeof(TexExport::Data::staging_buffer);
          l_PropertyInfo.type =
        ...
        }
        {
          ...
          l_PropertyInfo.size = sizeof(TexExport::Data::frame_index);
        ...
        }
        {
          ...
          l_PropertyInfo.size = sizeof(TexExport::Data::name);
      ...
      {
        if (m_Data.m_Type != TexExport::ms_TypeId) {
          return false;
        }
        u32 l_PageIndex = 0;
        u32 l_SlotIndex = 0;
        ...
        Low::Util::Instances::Page *l_Page = ms_Pages[l_PageIndex];
        return m_Data.m_Type == TexExport::ms_TypeId &&
      ...
      void TexExport::serialize(Low::Util::Serial::Node &p_Node) const
      {
        _LOW_ASSERT(is_alive());
      ...
      Low::Util::Handle
      TexExport::deserialize(Low::Util::Serial::Node &p_Node,
      ...
      uint32_t TexExport::create_instance(u32 &p_PageIndex,
                                          u32 &p_SlotIndex)
      {
        u32 l_Index = 0;
        u32 l_PageIndex = 0;
