...
namespace Low {
  namespace Renderer {
    namespace Vulkan {
      ...
      void Scene::initialize()
      {
        ...
        l_TypeInfo.uiComponent = false;
        {
          ...
          l_PropertyInfo.dataOffset =
              offsetof(Scene::Data, point_light_slots);
          l_PropertyInfo.size =
              sizeof(Scene::Data::point_light_slots);
          l_PropertyInfo.type =
        ...
        }
        {
          ...
          l_PropertyInfo.editorProperty = false;
          l_PropertyInfo.dataOffset =
              offsetof(Scene::Data, point_light_buffer);
          l_PropertyInfo.size =
              sizeof(Scene::Data::point_light_buffer);
          l_PropertyInfo.type =
              Low::Util::RTTI::PropertyType::UNKNOWN;
          l_PropertyInfo.handleType = 0;
          l_PropertyInfo.get_return =
        ...
        }
        {
          ...
          l_PropertyInfo.size = sizeof(Scene::Data::initialized);
      ...
      uint32_t Scene::create_instance(u32 &p_PageIndex,
                                      u32 &p_SlotIndex)
      {
        u32 l_Index = 0;
        u32 l_PageIndex = 0;
