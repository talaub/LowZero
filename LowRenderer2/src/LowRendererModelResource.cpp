  ...
  namespace Renderer {
    ...
    void ModelResource::initialize()
    {
      ...
      l_TypeInfo.uiComponent = false;
      {
        ...
        l_PropertyInfo.size = sizeof(ModelResource::Data::path);
      ...
      }
      {
        ...
        l_PropertyInfo.size = sizeof(ModelResource::Data::name);
    ...
    uint32_t ModelResource::create_instance(u32 &p_PageIndex,
                                            u32 &p_SlotIndex)
    {
      u32 l_Index = 0;
      u32 l_PageIndex = 0;
