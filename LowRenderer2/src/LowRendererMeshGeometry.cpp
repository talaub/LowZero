...
namespace Low {
  namespace Renderer {
    ...
    u16 MeshGeometry::ms_TypeId = 0;
    const Low::Util::TypeIdentifier
        MeshGeometry::IDENTIFIER(LOW_NAME(509652687),
                                 LOW_NAME(123331768));
    ...
    void MeshGeometry::initialize()
    {
      ...
      l_TypeInfo.uiComponent = false;
      {
        ...
        l_PropertyInfo.size =
            sizeof(MeshGeometry::Data::submesh_count);
      ...
      }
      {
        ...
        l_PropertyInfo.size = sizeof(MeshGeometry::Data::submeshes);
      ...
      }
      {
        ...
        l_PropertyInfo.size = sizeof(MeshGeometry::Data::aabb);
        l_PropertyInfo.type = Low::Util::RTTI::PropertyType::UNKNOWN;
        l_PropertyInfo.handleType = 0;
        l_PropertyInfo.get_return =
            [](Low::Util::Handle p_Handle) -> void const * {
      ...
      }
      {
        ...
        l_PropertyInfo.size =
            sizeof(MeshGeometry::Data::bounding_sphere);
        l_PropertyInfo.type = Low::Util::RTTI::PropertyType::UNKNOWN;
        l_PropertyInfo.handleType = 0;
        l_PropertyInfo.get_return =
            [](Low::Util::Handle p_Handle) -> void const * {
      ...
      }
      {
        ...
        l_PropertyInfo.size = sizeof(MeshGeometry::Data::nodes);
        l_PropertyInfo.type = Low::Util::RTTI::PropertyType::UNKNOWN;
        l_PropertyInfo.handleType = 0;
        l_PropertyInfo.get_return =
            [](Low::Util::Handle p_Handle) -> void const * {
      ...
      }
      {
        ...
        l_PropertyInfo.size = sizeof(MeshGeometry::Data::name);
    ...
    {
      if (m_Data.m_Type != MeshGeometry::ms_TypeId) {
        return false;
      }
      u32 l_PageIndex = 0;
      u32 l_SlotIndex = 0;
    ...
    void
    MeshGeometry::serialize(Low::Util::Serial::Node &p_Node) const
    {
      _LOW_ASSERT(is_alive());
    ...
    Low::Util::Handle
    MeshGeometry::deserialize(Low::Util::Serial::Node &p_Node,
