...
namespace Flode {
  namespace OperatorNodes {
    ...
    void
    GreaterEqualsNode::serialize(Low::Util::Serial::Node &p_Node) const
    {
      p_Node["pintype"] =
          Flode::pin_type_to_string(m_PinType).c_str();
    }

    void GreaterEqualsNode::deserialize(Low::Util::Serial::Node &p_Node)
    {
      if (p_Node["pintype"]) {
    ...
    void LessEqualsNode::serialize(Low::Util::Serial::Node &p_Node) const
    {
      p_Node["pintype"] =
          Flode::pin_type_to_string(m_PinType).c_str();
    }

    void LessEqualsNode::deserialize(Low::Util::Serial::Node &p_Node)
    {
      if (p_Node["pintype"]) {
        m_PinType = Flode::string_to_pin_type(
            p_Node["pintype"].as<Low::Util::String>());
    ...
    void LessNode::serialize(Low::Util::Serial::Node &p_Node) const
    {
      p_Node["pintype"] =
          Flode::pin_type_to_string(m_PinType).c_str();
    }

    void LessNode::deserialize(Low::Util::Serial::Node &p_Node)
    {
      if (p_Node["pintype"]) {
        m_PinType = Flode::string_to_pin_type(
            p_Node["pintype"].as<Low::Util::String>());
    ...
    void GreaterNode::serialize(Low::Util::Serial::Node &p_Node) const
    {
      p_Node["pintype"] =
          Flode::pin_type_to_string(m_PinType).c_str();
    }

    void GreaterNode::deserialize(Low::Util::Serial::Node &p_Node)
    {
      if (p_Node["pintype"]) {
        m_PinType = Flode::string_to_pin_type(
            p_Node["pintype"].as<Low::Util::String>());
