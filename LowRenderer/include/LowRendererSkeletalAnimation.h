...
namespace Low {
  namespace Renderer {
    ...
    public:
      ...
      SkeletalAnimation(u64 p_Id) : Low::Util::Handle(p_Id)
      {
      }
      SkeletalAnimation() : Low::Util::Handle()
      {
      }
      SkeletalAnimation(Low::Util::Handle p_Handle)
      ...
      SkeletalAnimation &
      operator=(const SkeletalAnimation &) = default;
      SkeletalAnimation &
      operator=(SkeletalAnimation &&) noexcept = default;
