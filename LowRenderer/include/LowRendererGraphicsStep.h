...
namespace Low {
  namespace Renderer {
    ...
    public:
      ...
      GraphicsStep(u64 p_Id) : Low::Util::Handle(p_Id)
      {
      }
      GraphicsStep() : Low::Util::Handle()
      {
      }
      GraphicsStep(Low::Util::Handle p_Handle)
      ...
      GraphicsStep &operator=(const GraphicsStep &) = default;
      GraphicsStep &operator=(GraphicsStep &&) noexcept = default;
