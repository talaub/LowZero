  ...
  namespace Renderer {
    namespace Interface {
      ...
      public:
        ...
        ComputePipeline(u64 p_Id) : Low::Util::Handle(p_Id)
        {
        }
        ComputePipeline() : Low::Util::Handle()
        {
        }
        ComputePipeline(Low::Util::Handle p_Handle)
        ...
        ComputePipeline &
        operator=(ComputePipeline &&) noexcept = default;
        ...
        static ComputePipeline create_handle_by_index(u32 p_Index);

        static ComputePipeline find_by_index(uint32_t p_Index);
        ...
        static ComputePipeline duplicate(ComputePipeline p_Handle,
                                         Low::Util::Name p_Name);
        static Low::Util::Handle
        _duplicate(Low::Util::Handle p_Handle,
                   Low::Util::Name p_Name);

        static ComputePipeline find_by_name(Low::Util::Name p_Name);
        static Low::Util::Handle
