  ...
  namespace Renderer {
    ...
    void ComputeStepConfig::initialize()
    {
      ...
      l_TypeInfo.uiComponent = false;
      {
        ...
        l_PropertyInfo.size =
            sizeof(ComputeStepConfig::Data::callbacks);
      ...
      }
      {
        ...
        l_PropertyInfo.size =
            sizeof(ComputeStepConfig::Data::resources);
        l_PropertyInfo.type = Low::Util::RTTI::PropertyType::UNKNOWN;
        l_PropertyInfo.handleType = 0;
        l_PropertyInfo.get_return =
            [](Low::Util::Handle p_Handle) -> void const * {
      ...
      }
      {
        ...
        l_PropertyInfo.size =
            sizeof(ComputeStepConfig::Data::pipelines);
        l_PropertyInfo.type = Low::Util::RTTI::PropertyType::UNKNOWN;
        l_PropertyInfo.handleType = 0;
        l_PropertyInfo.get_return =
            [](Low::Util::Handle p_Handle) -> void const * {
      ...
      }
      {
        ...
        l_PropertyInfo.size =
            sizeof(ComputeStepConfig::Data::output_image);
        l_PropertyInfo.type = Low::Util::RTTI::PropertyType::UNKNOWN;
        l_PropertyInfo.handleType = 0;
        l_PropertyInfo.get_return =
            [](Low::Util::Handle p_Handle) -> void const * {
      ...
      }
      {
        ...
        l_PropertyInfo.size = sizeof(ComputeStepConfig::Data::name);
    ...
    uint32_t ComputeStepConfig::create_instance(u32 &p_PageIndex,
                                                u32 &p_SlotIndex)
    {
      u32 l_Index = 0;
      u32 l_PageIndex = 0;
