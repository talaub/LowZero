      ...
      namespace ContextHelper {
        ...
        static void setup_imgui(Backend::Context &p_Context)
        {
          ...
          }
          {
            ...
            colors[ImGuiCol_FrameBgActive] = ImVec4(0.47f, 0.47f, 0.47f, 0.54f);
            colors[ImGuiCol_TitleBg] = ImVec4(0.07f, 0.08f, 0.08f, 1.00f);
            colors[ImGuiCol_TitleBgActive] = ImVec4(0.07f, 0.08f, 0.08f, 1.00f);
            ...
            colors[ImGuiCol_ScrollbarGrabActive] =
                ImVec4(0.41f, 0.41f, 0.41f, 1.00f);
            colors[ImGuiCol_CheckMark] = ImVec4(1.00f, 1.00f, 1.00f, 0.54f);
            ...
            colors[ImGuiCol_TabUnfocused] = ImVec4(0.07f, 0.08f, 0.08f, 1.00f);
