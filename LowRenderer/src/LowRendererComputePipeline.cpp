...
namespace Low {
  namespace Renderer {
    namespace Interface {
      const uint16_t ComputePipeline::TYPE_ID = 11;
      ...
      void ComputePipeline::destroy()
      {
        ...
        ShaderProgramUtils::delist_compute_pipeline(*this);
      ...
      Low::Renderer::Backend::Pipeline &ComputePipeline::get_pipeline() const
      {
        _LOW_ASSERT(is_alive());
        return TYPE_SOA(ComputePipeline, pipeline,
                            ...
                            ComputePipelineCreateParams &p_Params)
      {
        ...
        ShaderProgramUtils::register_compute_pipeline(l_Pipeline, p_Params);

        return l_Pipeline;
        // LOW_CODEGEN::END::CUSTOM:FUNCTION_make
      }

      void ComputePipeline::bind(CommandBuffer p_CommandBuffer)
      {
