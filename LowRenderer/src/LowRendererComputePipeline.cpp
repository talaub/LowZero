...
namespace Low {
  namespace Renderer {
    namespace Interface {
      ...
      u16 ComputePipeline::ms_TypeId = 0;
      const Low::Util::TypeIdentifier
          ComputePipeline::IDENTIFIER(LOW_NAME(1849087878),
                                      LOW_NAME(1006791094));
      ...
      ComputePipeline ComputePipeline::make(Low::Util::Name p_Name)
      {
        ...
        l_Handle.m_Data.m_Type = ComputePipeline::ms_TypeId;
      ...
      {
        if (m_Data.m_Type != ComputePipeline::ms_TypeId) {
          return false;
        }
        u32 l_PageIndex = 0;
        u32 l_SlotIndex = 0;
        ...
        Low::Util::Instances::Page *l_Page = ms_Pages[l_PageIndex];
        return m_Data.m_Type == ComputePipeline::ms_TypeId &&
      ...
      void ComputePipeline::serialize(
      ...
      Low::Util::Handle
      ComputePipeline::deserialize(Low::Util::Serial::Node &p_Node,
      ...
      uint32_t ComputePipeline::create_instance(u32 &p_PageIndex,
                                                u32 &p_SlotIndex)
      {
        u32 l_Index = 0;
        u32 l_PageIndex = 0;
