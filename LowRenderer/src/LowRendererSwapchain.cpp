  ...
  namespace Renderer {
    namespace Interface {
      ...
      void Swapchain::initialize()
      {
        ...
        LOW_PROFILE_ALLOC(type_buffer_Swapchain);
        LOW_PROFILE_ALLOC(type_slots_Swapchain);
      }
      ...
      void Swapchain::cleanup()
      {
        ...
        LOW_PROFILE_FREE(type_buffer_Swapchain);
        LOW_PROFILE_FREE(type_slots_Swapchain);
      }
      ...
      uint32_t Swapchain::get_capacity()
      {
        ...
        if (l_Capacity == 0u) {
          l_Capacity =
              Low::Util::Config::get_capacity(N(LowRenderer), N(Swapchain));
        }
        return l_Capacity;
      }
