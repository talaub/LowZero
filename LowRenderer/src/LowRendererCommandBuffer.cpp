...
namespace Low {
  namespace Renderer {
    namespace Interface {
      const uint16_t CommandBuffer::TYPE_ID = 6;
      ...
      void CommandBuffer::initialize()
      {
        ...
        LOW_PROFILE_ALLOC(type_buffer_CommandBuffer);
        LOW_PROFILE_ALLOC(type_slots_CommandBuffer);
      }
      ...
      void CommandBuffer::cleanup()
      {
        ...
        LOW_PROFILE_FREE(type_buffer_CommandBuffer);
        LOW_PROFILE_FREE(type_slots_CommandBuffer);
      }
      ...
      uint32_t CommandBuffer::get_capacity()
      {
        ...
        if (l_Capacity == 0u) {
          l_Capacity =
              Low::Util::Config::get_capacity(N(LowRenderer), N(CommandBuffer));
        }
        return l_Capacity;
      }
