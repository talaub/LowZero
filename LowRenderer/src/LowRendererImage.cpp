  ...
  namespace Renderer {
    namespace Resource {
      ...
      const Low::Util::TypeIdentifier
          Image::IDENTIFIER(LOW_NAME(1849087878), LOW_NAME(83635035));
      ...
      Image Image::make(Low::Util::Name p_Name)
      {
        ...
        new (ACCESSOR_TYPE_SOA_PTR(l_Handle, Image, image,
      ...
      void Image::initialize()
      {
        ...
        l_TypeInfo.uiComponent = false;
        {
          ...
          l_PropertyInfo.dataOffset = offsetof(Image::Data, image);
          l_PropertyInfo.size = sizeof(Image::Data::image);
          l_PropertyInfo.type =
