...
static std::unordered_set<std::string> angelscript_keywords = {
    "abstract", "and", "auto", "bool", "break", "case", "cast", "class", "const", "continue", "default", "do", "double", "else", "enum", "explicit", "external", "false", "final", "float", "for", "from", "funcdef", "get", "if",
    "import", "in", "inout", "int", "int8", "int16", "int32", "int64", "interface", "is", "mixin", "namespace", "not", "null", "or", "out", "override", "private", "protected", "return", "set", "shared", "super", "switch", "this",
    "true", "typedef", "uint", "uint8", "uint16", "uint32", "uint64", "void", "while", "xor"
};

static std::unordered_set<std::string> angelscript_identifiers = {
    "array", "dictionary", "string", "ref", "weakref", "math", "Low", "Core", "UI", "Vector2", "Vector3", "Vector4", "Quaternion", "Color", "Name", "Handle"
};
...
void RegisterSyntaxProviders(ZepEditor& editor)
{
    ...
    editor.RegisterSyntaxFactory({ ".as", ".angelscript" }, SyntaxProvider{ "angelscript", tSyntaxFactory([](ZepBuffer* pBuffer) {
                                                                                return std::make_shared<ZepSyntax>(*pBuffer, angelscript_keywords, angelscript_identifiers);
                                                                            }) });
