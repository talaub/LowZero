...
namespace Low {
  namespace Core {
    ...
    public:
      ...
      GameMode(u64 p_Id) : Low::Util::Handle(p_Id)
      {
      }
      GameMode() : Low::Util::Handle()
      {
      }
      GameMode(Low::Util::Handle p_Handle)
      ...
      GameMode &operator=(GameMode &&) noexcept = default;
      ...
      static GameMode create_handle_by_index(u32 p_Index);
