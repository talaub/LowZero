...
namespace Low {
  namespace Core {
    namespace Scripting {
      ...
      struct LOW_CORE_API Asset : public Low::Util::Handle
      {
      public:
        struct Data
        {
      ...
      public:
        ...
        static Low::Util::List<Asset> ms_LivingInstances;
        ...
        static Asset make(Low::Util::Name p_Name);
        static Low::Util::Handle _make(Low::Util::Name p_Name);
        static Asset make(Low::Util::Name p_Name,
                          Low::Util::UniqueId p_UniqueId);
        explicit Asset(const Asset &p_Copy)
        ...
        Asset(u64 p_Id) : Low::Util::Handle(p_Id)
        {
        }
        Asset() : Low::Util::Handle()
        {
        }
        Asset(Low::Util::Handle p_Handle)
        ...
        static Asset create_handle_by_index(u32 p_Index);

        static Asset find_by_index(uint32_t p_Index);
        ...
        Asset duplicate(Low::Util::Name p_Name) const;
        static Asset duplicate(Asset p_Handle,
                               Low::Util::Name p_Name);
        static Low::Util::Handle
        _duplicate(Low::Util::Handle p_Handle,
                   Low::Util::Name p_Name);

        static Asset find_by_name(Low::Util::Name p_Name);
        static Low::Util::Handle
...
namespace Low {
  namespace Core {
    typedef Scripting::Asset ScriptAsset;
  }
} // namespace Low
