  ...
  namespace Core {
    namespace Component {
      ...
      public:
        ...
        NavmeshAgent(u64 p_Id) : Low::Util::Handle(p_Id)
        {
        }
        NavmeshAgent() : Low::Util::Handle()
        {
        }
        NavmeshAgent(Low::Util::Handle p_Handle)
        ...
        NavmeshAgent &operator=(const NavmeshAgent &) = default;
        NavmeshAgent &operator=(NavmeshAgent &&) noexcept = default;
        ...
        void set_target_position(Low::Math::Vector3 p_TargetPosition);
