  ...
  namespace Core {
    namespace Navigation {
      ...
      public:
        ...
        Low::Math::Bounds &get_bounds() const;
        void set_bounds(Low::Math::Bounds &p_Value);

        bool is_bounds_valid() const;
        void set_bounds_valid(bool p_Value);
        void toggle_bounds_valid();
