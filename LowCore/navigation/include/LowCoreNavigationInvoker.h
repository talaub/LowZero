...
namespace Low {
  namespace Core {
    namespace Navigation {
      ...
      struct LOW_CORE_API Invoker : public Low::Util::Handle
      {
      public:
        struct Data
        {
      ...
      public:
        ...
        static Low::Util::List<Invoker> ms_LivingInstances;
        ...
        static Invoker make(Low::Core::Entity p_Entity);
        static Low::Util::Handle _make(Low::Util::Handle p_Entity);
        static Invoker make(Low::Core::Entity p_Entity,
                            Low::Util::UniqueId p_UniqueId);
        explicit Invoker(const Invoker &p_Copy)
        ...
        Invoker(u64 p_Id) : Low::Util::Handle(p_Id)
        {
        }
        Invoker() : Low::Util::Handle()
        {
        }
        Invoker(Low::Util::Handle p_Handle)
        ...
        static Invoker *living_instances()
        {
          return ms_LivingInstances.data();
        }

        static Invoker create_handle_by_index(u32 p_Index);

        static Invoker find_by_index(uint32_t p_Index);
        ...
        Invoker duplicate(Low::Core::Entity p_Entity) const;
        static Invoker duplicate(Invoker p_Handle,
        ...
        float get_generation_radius() const;
        void set_generation_radius(float p_Value);

        float get_removal_radius() const;
        void set_removal_radius(float p_Value);
