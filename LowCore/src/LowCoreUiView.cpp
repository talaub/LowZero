        ...
        namespace Low {
          namespace Core {
            namespace UI {
              ...
              Low::Util::SharedMutex View::ms_PagesMutex;
              Low::Util::UniqueLock<Low::Util::SharedMutex>
                  View::ms_PagesLock(View::ms_PagesMutex,
                                     std::defer_lock);
              Low::Util::List<View> View::ms_LivingInstances;
                              ...
                              Low::Util::UniqueId p_UniqueId)
              {
                ...
                uint32_t l_Index = create_instance(
                    l_PageIndex, l_SlotIndex, l_PageLock);

                View l_Handle;
                l_Handle.m_Data.m_Index = l_Index;
                l_Handle.m_Data.m_Generation =
                    ms_Pages[l_PageIndex]
                        ->slots[l_SlotIndex]
                        .m_Generation;
                l_Handle.m_Data.m_Type = View::ms_TypeId;
                ...
                ACCESSOR_TYPE_SOA(l_Handle, View, loaded, bool) =
                    false;
                new (ACCESSOR_TYPE_SOA_PTR(l_Handle, View, elements,
                                           Util::Set<Util::UniqueId>))
                    Util::Set<Util::UniqueId>();
                ACCESSOR_TYPE_SOA(l_Handle, View, internal, bool) =
                    false;
                ACCESSOR_TYPE_SOA(l_Handle, View, view_template,
                                  bool) = false;
                ACCESSOR_TYPE_SOA(l_Handle, View, rotation, float) =
                    0.0f;
                ACCESSOR_TYPE_SOA(l_Handle, View, scale_multiplier,
                                  float) = 0.0f;
                new (ACCESSOR_TYPE_SOA_PTR(l_Handle, View, canvas,
                                           Low::Renderer::UiCanvas))
                    Low::Renderer::UiCanvas();
                ACCESSOR_TYPE_SOA(l_Handle, View, transform_dirty,
                                  bool) = false;
                ACCESSOR_TYPE_SOA(l_Handle, View, name,
                                  Low::Util::Name) =
                    Low::Util::Name(0u);
                ...
                if (p_UniqueId > 0ull) {
                  ...
                  l_Handle.set_unique_id(
                      Low::Util::generate_unique_id(
                          l_Handle.get_id()));
                }
                Low::Util::register_unique_id(
                    l_Handle.get_unique_id(), l_Handle.get_id());
              ...
              void View::destroy()
              {
                ...
                u32 l_PageIndex = 0;
                u32 l_SlotIndex = 0;
                _LOW_ASSERT(get_page_for_index(
                    get_index(), l_PageIndex, l_SlotIndex));
              ...
              void View::initialize()
              {
                ...
                ms_PageSize = Low::Math::Util::clamp(
                    Low::Math::Util::next_power_of_two(ms_Capacity),
                    8, 32);
                {
                  u32 l_Capacity = 0u;
                ...
                l_TypeInfo.uiComponent = false;
                {
                  ...
                  l_PropertyInfo.get_return =
                    ...
                    Low::Util::HandleLock<View> l_HandleLock(
                        l_Handle);
                    l_Handle.is_loaded();
                ...
                }
                {
                  ...
                  l_PropertyInfo.get_return =
                    ...
                    return (void *)&ACCESSOR_TYPE_SOA(
                        p_Handle, View, view_template, bool);
                  };
                  l_PropertyInfo.set =
                      [](Low::Util::Handle p_Handle,
                         const void *p_Data) -> void {
                ...
                }
                {
                  ...
                  l_PropertyInfo.get_return =
                    ...
                    return (void *)&ACCESSOR_TYPE_SOA(
                        p_Handle, View, layer_offset, uint32_t);
                  };
                  l_PropertyInfo.set =
                      [](Low::Util::Handle p_Handle,
                         const void *p_Data) -> void {
                ...
                }
                {
                  ...
                  l_PropertyInfo.get_return =
                    ...
                    return (void *)&ACCESSOR_TYPE_SOA(
                        p_Handle, View, transform_dirty, bool);
                  };
                  l_PropertyInfo.set =
                      [](Low::Util::Handle p_Handle,
                         const void *p_Data) -> void {
                ...
                }
                {
                  ...
                  l_PropertyInfo.get_return =
                    ...
                    l_Handle.get_name();
                    return (void *)&ACCESSOR_TYPE_SOA(
                        p_Handle, View, name, Low::Util::Name);
                  };
                  l_PropertyInfo.set =
                      [](Low::Util::Handle p_Handle,
                         const void *p_Data) -> void {
                ...
                }
                {
                  ...
                  l_FunctionInfo.type =
                      Low::Util::RTTI::PropertyType::VOID;
                  l_FunctionInfo.handleType = 0;
                  {
                    ...
                    l_FunctionInfo.parameters.push_back(
                        l_ParameterInfo);
                  }
              ...
              void View::cleanup()
              {
                Low::Util::List<View> l_Instances =
                    ms_LivingInstances;
                for (uint32_t i = 0u; i < l_Instances.size(); ++i) {
                  l_Instances[i].destroy();
                }
                ms_PagesLock.lock();
                for (auto it = ms_Pages.begin();
                     it != ms_Pages.end();) {
              ...
              {
                LOW_ASSERT(p_Index < get_capacity(),
                           "Index out of bounds");
              ...
              Low::Util::Handle
              View::_find_by_name(Low::Util::Name p_Name)
              {
              ...
              View View::duplicate(Low::Util::Name p_Name) const
              {
                ...
                LOW_ASSERT(is_loaded(),
                           "Cannot duplicate unloaded view");
                ...
                for (Util::UniqueId i_UniqueId : l_Elements) {
                  Element i_Element =
                      Util::find_handle_by_unique_id(i_UniqueId)
                          .get_id();
              ...
              View View::duplicate(View p_Handle,
              ...
              Low::Util::Handle
              View::_duplicate(Low::Util::Handle p_Handle,
                               Low::Util::Name p_Name)
              {
              ...
              void
              View::serialize(Low::Util::Serial::Node &p_Node) const
              {
                _LOW_ASSERT(is_alive());
                                ...
                                Low::Util::Handle p_Creator)
              {
                ...
                if (p_Node["canvas"]) {
                  l_Handle.set_canvas(
                      Low::Renderer::UiCanvas::deserialize(
              ...
              void View::broadcast_observable(
              ...
              Low::Math::Vector2 View::pixel_position() const
              {
                ...
                return TYPE_SOA(View, pixel_position,
                                Low::Math::Vector2);
              }
              ...
              void View::set_canvas(Low::Renderer::UiCanvas p_Value)
              {
                ...
                // Set new value
                TYPE_SOA(View, canvas, Low::Renderer::UiCanvas) =
                    p_Value;
              ...
              void View::set_unique_id(Low::Util::UniqueId p_Value)
              {
                ...
                // Set new value
                TYPE_SOA(View, unique_id, Low::Util::UniqueId) =
                    p_Value;
              ...
              void
              View::serialize_elements(Util::Serial::Node &p_Node)
              {
                Low::Util::HandleLock<View> l_Lock(get_id());
              ...
              void View::load_elements()
              {
                ...
                Util::Serial::Node l_ElementsNode =
                    l_RootNode["elements"];
              ...
              void View::unload_elements()
              {
                ...
                while (!get_elements().empty()) {
                  Element i_Element = Util::find_handle_by_unique_id(
                                          *get_elements().begin())
                                          .get_id();
                  i_Element.destroy();
                }
              ...
              Low::Core::UI::View
              View::spawn_instance(Low::Util::Name p_Name)
              {
                Low::Util::HandleLock<View> l_Lock(get_id());
                  ...
                  Low::Util::UniqueLock<Low::Util::Mutex> &p_PageLock)
              {
                ...
                ms_Pages[l_PageIndex]->slots[l_SlotIndex].m_Occupied =
                    true;
              ...
              u32 View::create_page()
              {
                ...
                LOW_ASSERT((l_Capacity + ms_PageSize) <
                               LOW_UINT32_MAX,
