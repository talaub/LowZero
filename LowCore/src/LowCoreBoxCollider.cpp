  ...
  namespace Core {
    namespace Component {
                                    ...
                                    Low::Util::UniqueId p_UniqueId)
      {
        ...
        ACCESSOR_TYPE_SOA(l_Handle, BoxCollider, rotation,
                          Low::Math::Quaternion) =
      ...
      Low::Math::Quaternion BoxCollider::get_rotation() const
      {
        _LOW_ASSERT(is_alive());
        ...
        return TYPE_SOA(BoxCollider, rotation, Low::Math::Quaternion);
      }
      void BoxCollider::set_rotation(Low::Math::Quaternion p_Value)
      {
        _LOW_ASSERT(is_alive());
        ...
        if (get_rotation() != p_Value) {
          ...
          // Set new value
          TYPE_SOA(BoxCollider, rotation, Low::Math::Quaternion) =
              p_Value;
          {
            Low::Core::Entity l_Entity = get_entity();
            if (l_Entity.has_component(
      ...
      void BoxCollider::rebuild()
      {
        ...
        l_Shape.box.rotation = get_rotation();
        ...
        if (l_Entity.has_component(Rigidbody::type_id())) {
          ...
          Low::Core::Physics::Body l_Body =
              Low::Core::Physics::Body::make(
                  ...
                  l_Transform.get_world_rotation() * get_rotation(),
