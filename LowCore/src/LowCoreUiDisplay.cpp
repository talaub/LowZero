  ...
  namespace Core {
    namespace UI {
      namespace Component {
        ...
        Low::Util::SharedMutex Display::ms_PagesMutex;
        Low::Util::UniqueLock<Low::Util::SharedMutex>
            Display::ms_PagesLock(Display::ms_PagesMutex,
                                  std::defer_lock);
                              ...
                              Low::Util::UniqueId p_UniqueId)
        {
          ...
          ACCESSOR_TYPE_SOA(l_Handle, Display, world_updated, bool) =
              false;
          new (ACCESSOR_TYPE_SOA_PTR(l_Handle, Display, element,
                                     Low::Core::UI::Element))
              Low::Core::UI::Element();
        ...
        void Display::initialize()
        {
              ...
              Low::Math::Util::next_power_of_two(ms_Capacity), 8, 32);
          {
            ...
            while (l_Capacity < ms_Capacity) {
              ...
              Low::Util::Instances::initialize_page(
                  i_Page, Display::Data::get_size(), ms_PageSize);
          ...
          }
          {
            ...
            l_PropertyInfo.get = [](Low::Util::Handle p_Handle,
              ...
              Display l_Handle = p_Handle.get_id();
              Low::Util::HandleLock<Display> l_HandleLock(l_Handle);
              *((uint32_t *)p_Data) = l_Handle.layer();
            };
            l_TypeInfo.properties[l_PropertyInfo.name] =
                l_PropertyInfo;
            // End property: layer
          ...
          {
            // Property: absolute_pixel_position
            Low::Util::RTTI::PropertyInfo l_PropertyInfo;
            ...
            l_TypeInfo.properties[l_PropertyInfo.name] =
                l_PropertyInfo;
            // End property: absolute_pixel_position
          }
          {
            // Property: absolute_rotation
            Low::Util::RTTI::PropertyInfo l_PropertyInfo;
            ...
            l_PropertyInfo.get = [](Low::Util::Handle p_Handle,
              ...
              Display l_Handle = p_Handle.get_id();
              Low::Util::HandleLock<Display> l_HandleLock(l_Handle);
              *((float *)p_Data) = l_Handle.get_absolute_rotation();
            };
            l_TypeInfo.properties[l_PropertyInfo.name] =
                l_PropertyInfo;
            // End property: absolute_rotation
          }
          {
            // Property: absolute_pixel_scale
            Low::Util::RTTI::PropertyInfo l_PropertyInfo;
            ...
            l_TypeInfo.properties[l_PropertyInfo.name] =
                l_PropertyInfo;
            // End property: absolute_pixel_scale
          }
          {
            // Property: absolute_layer
            Low::Util::RTTI::PropertyInfo l_PropertyInfo;
            ...
            l_PropertyInfo.get = [](Low::Util::Handle p_Handle,
              ...
              Display l_Handle = p_Handle.get_id();
              Low::Util::HandleLock<Display> l_HandleLock(l_Handle);
              *((uint32_t *)p_Data) = l_Handle.get_absolute_layer();
            };
            l_TypeInfo.properties[l_PropertyInfo.name] =
                l_PropertyInfo;
            // End property: absolute_layer
          }
          {
          ...
          {
            // Function: get_absolute_layer_float
            Low::Util::RTTI::FunctionInfo l_FunctionInfo;
            ...
            l_TypeInfo.functions[l_FunctionInfo.name] =
                l_FunctionInfo;
            // End function: get_absolute_layer_float
          }
          {
            // Function: point_is_in_bounding_box
            Low::Util::RTTI::FunctionInfo l_FunctionInfo;
        ...
        Display Display::create_handle_by_index(u32 p_Index)
        {
                             ...
                             Low::Util::Handle p_Creator)
        {
          ...
          Display l_Handle =
              Display::make(p_Creator.get_id(), l_HandleUniqueId);
        ...
        u64
        Display::observe(Low::Util::Name p_Observable,
        ...
        u32 Display::create_page()
        {
          const u32 l_Capacity = get_capacity();
          LOW_ASSERT((l_Capacity + ms_PageSize) < LOW_UINT32_MAX,
                     "Could not increase capacity for Display.");

          Low::Util::Instances::Page *l_Page =
              new Low::Util::Instances::Page;
          Low::Util::Instances::initialize_page(
              l_Page, Display::Data::get_size(), ms_PageSize);
        ...
        bool Display::get_page_for_index(const u32 p_Index,
                                         u32 &p_PageIndex,
                                         u32 &p_SlotIndex)
        {
          if (p_Index >= get_capacity()) {
