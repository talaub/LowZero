...
namespace Low {
  namespace Core {
    namespace Component {
      ...
      Low::Util::Set<Low::Core::Component::SphereCollider>
          Low::Core::Component::SphereCollider::ms_Dirty;
      ...
      u16 SphereCollider::ms_TypeId = 0;
      const Low::Util::TypeIdentifier
          SphereCollider::IDENTIFIER(LOW_NAME(1181529166),
                                     LOW_NAME(2379850287));
      uint32_t SphereCollider::ms_Capacity = 0u;
      uint32_t SphereCollider::ms_PageSize = 0u;
      Low::Util::List<SphereCollider>
          SphereCollider::ms_LivingInstances;
      Low::Util::List<Low::Util::Instances::Page *>
          SphereCollider::ms_Pages;

      Low::Util::Handle
      SphereCollider::_make(Low::Util::Handle p_Entity)
      {
      ...
      SphereCollider SphereCollider::make(Low::Core::Entity p_Entity)
      {
        return make(p_Entity, 0ull);
      }

      SphereCollider
      SphereCollider::make(Low::Core::Entity p_Entity,
                           Low::Util::UniqueId p_UniqueId)
      {
        ...
        SphereCollider l_Handle;
        l_Handle.m_Data.m_Index = l_Index;
        l_Handle.m_Data.m_Generation =
            ms_Pages[l_PageIndex]->slots[l_SlotIndex].m_Generation;
        l_Handle.m_Data.m_Type = SphereCollider::ms_TypeId;

        ACCESSOR_TYPE_SOA(l_Handle, SphereCollider, radius, float) =
            0.0f;
        ACCESSOR_TYPE_SOA(l_Handle, SphereCollider, trigger, bool) =
            false;
        new (ACCESSOR_TYPE_SOA_PTR(l_Handle, SphereCollider, shape,
                                   Low::Core::Physics::Shape))
            Low::Core::Physics::Shape();
        new (ACCESSOR_TYPE_SOA_PTR(
            l_Handle, SphereCollider, static_body,
            Low::Core::Physics::Body)) Low::Core::Physics::Body();
        ACCESSOR_TYPE_SOA(l_Handle, SphereCollider, initialized,
                          bool) = false;
        new (ACCESSOR_TYPE_SOA_PTR(l_Handle, SphereCollider, entity,
                                   Low::Core::Entity))
            Low::Core::Entity();
        ACCESSOR_TYPE_SOA(l_Handle, SphereCollider, dirty, bool) =
            false;
        ...
        ACCESSOR_TYPE_SOA(l_Handle, SphereCollider, center,
                          Low::Math::Vector3) =
      ...
      void SphereCollider::initialize()
      {
            ...
            Low::Math::Util::next_power_of_two(ms_Capacity), 8, 32);
        {
          ...
          while (l_Capacity < ms_Capacity) {
            ...
            Low::Util::Instances::initialize_page(
                i_Page, SphereCollider::Data::get_size(),
                ms_PageSize);
        ...
        l_TypeInfo.name = N(SphereCollider);
        l_TypeInfo.typeId = ms_TypeId;
        l_TypeInfo.get_capacity = &get_capacity;
        l_TypeInfo.is_alive = &SphereCollider::is_alive;
        l_TypeInfo.destroy = &SphereCollider::destroy;
        l_TypeInfo.serialize = &SphereCollider::serialize;
        l_TypeInfo.deserialize = &SphereCollider::deserialize;
        l_TypeInfo.find_by_index = &SphereCollider::_find_by_index;
        l_TypeInfo.notify = &SphereCollider::_notify;
        l_TypeInfo.post_load = nullptr;
        l_TypeInfo.make_default = nullptr;
        l_TypeInfo.make_component = &SphereCollider::_make;
        l_TypeInfo.duplicate_default = nullptr;
        l_TypeInfo.duplicate_component = &SphereCollider::_duplicate;
        l_TypeInfo.get_living_instances =
            reinterpret_cast<Low::Util::RTTI::LivingInstancesGetter>(
                &SphereCollider::living_instances);
        l_TypeInfo.get_living_count = &SphereCollider::living_count;
        ...
        l_TypeInfo.uiComponent = false;
        {
          ...
          l_PropertyInfo.get_return =
            ...
            return (void *)&ACCESSOR_TYPE_SOA(
                p_Handle, SphereCollider, center, Low::Math::Vector3);
          };
        ...
        }
        {
          ...
          l_PropertyInfo.get_return =
            ...
            l_Handle.get_radius();
            return (void *)&ACCESSOR_TYPE_SOA(
                p_Handle, SphereCollider, radius, float);
          };
          l_PropertyInfo.set = [](Low::Util::Handle p_Handle,
                                  const void *p_Data) -> void {
            SphereCollider l_Handle = p_Handle.get_id();
        ...
        }
        {
          ...
          l_PropertyInfo.get_return =
            ...
            l_Handle.is_trigger();
            return (void *)&ACCESSOR_TYPE_SOA(
                p_Handle, SphereCollider, trigger, bool);
          };
          l_PropertyInfo.set = [](Low::Util::Handle p_Handle,
                                  const void *p_Data) -> void {
            SphereCollider l_Handle = p_Handle.get_id();
        ...
        }
        {
          ...
          l_PropertyInfo.get_return =
            ...
            return (void *)&ACCESSOR_TYPE_SOA(
                p_Handle, SphereCollider, static_body,
        ...
        }
        {
          ...
          l_PropertyInfo.get_return =
            ...
            return (void *)&ACCESSOR_TYPE_SOA(
                p_Handle, SphereCollider, initialized, bool);
          };
          l_PropertyInfo.set = [](Low::Util::Handle p_Handle,
                                  const void *p_Data) -> void {};
          l_PropertyInfo.get = [](Low::Util::Handle p_Handle,
        ...
        }
        {
          ...
          l_PropertyInfo.get_return =
            ...
            l_Handle.get_entity();
            return (void *)&ACCESSOR_TYPE_SOA(
                p_Handle, SphereCollider, entity, Low::Core::Entity);
          };
          l_PropertyInfo.set = [](Low::Util::Handle p_Handle,
                                  const void *p_Data) -> void {
            SphereCollider l_Handle = p_Handle.get_id();
        ...
        }
        {
          ...
          l_PropertyInfo.get_return =
            ...
            return (void *)&ACCESSOR_TYPE_SOA(
                p_Handle, SphereCollider, unique_id,
                Low::Util::UniqueId);
          };
          l_PropertyInfo.set = [](Low::Util::Handle p_Handle,
                                  const void *p_Data) -> void {};
        ...
        }
        {
          ...
          l_PropertyInfo.get_return =
            ...
            l_Handle.is_dirty();
            return (void *)&ACCESSOR_TYPE_SOA(
                p_Handle, SphereCollider, dirty, bool);
          };
          l_PropertyInfo.set = [](Low::Util::Handle p_Handle,
                                  const void *p_Data) -> void {
            SphereCollider l_Handle = p_Handle.get_id();
      ...
      {
        Low::Util::List<SphereCollider> l_Instances =
            ms_LivingInstances;
      ...
      Low::Util::Handle
      SphereCollider::_find_by_index(uint32_t p_Index)
      {
        return find_by_index(p_Index).get_id();
      }

      SphereCollider SphereCollider::find_by_index(uint32_t p_Index)
      {
      ...
      SphereCollider
      SphereCollider::create_handle_by_index(u32 p_Index)
      {
      ...
      bool SphereCollider::is_alive() const
      {
        if (m_Data.m_Type != SphereCollider::ms_TypeId) {
          return false;
        }
        u32 l_PageIndex = 0;
        u32 l_SlotIndex = 0;
        ...
        Low::Util::Instances::Page *l_Page = ms_Pages[l_PageIndex];
        return m_Data.m_Type == SphereCollider::ms_TypeId &&
               l_Page->slots[l_SlotIndex].m_Occupied &&
               l_Page->slots[l_SlotIndex].m_Generation ==
                   m_Data.m_Generation;
      }

      uint32_t SphereCollider::get_capacity()
      {
        return ms_Capacity;
      }
      ...
      SphereCollider::duplicate(Low::Core::Entity p_Entity) const
      {
        ...
        SphereCollider l_Handle = make(p_Entity);
      ...
      SphereCollider
      SphereCollider::duplicate(SphereCollider p_Handle,
      ...
      Low::Util::Handle
      SphereCollider::_duplicate(Low::Util::Handle p_Handle,
                                 Low::Util::Handle p_Entity)
      {
        SphereCollider l_SphereCollider = p_Handle.get_id();
        Low::Core::Entity l_Entity = p_Entity.get_id();
        return l_SphereCollider.duplicate(l_Entity);
      }

      void
      SphereCollider::serialize(Low::Util::Serial::Node &p_Node) const
      {
        _LOW_ASSERT(is_alive());
      ...
      void SphereCollider::serialize(Low::Util::Handle p_Handle,
                                     Low::Util::Serial::Node &p_Node)
      {
        SphereCollider l_SphereCollider = p_Handle.get_id();
        l_SphereCollider.serialize(p_Node);
      }

      Low::Util::Handle
      SphereCollider::deserialize(Low::Util::Serial::Node &p_Node,
                                  Low::Util::Handle p_Creator)
      {
        ...
        SphereCollider l_Handle = SphereCollider::make(
      ...
      void SphereCollider::broadcast_observable(
      ...
      u64 SphereCollider::observe(Low::Util::Name p_Observable,
      ...
      void SphereCollider::notify(Low::Util::Handle p_Observed,
                                  Low::Util::Name p_Observable)
      {
      ...
      void SphereCollider::_notify(Low::Util::Handle p_Observer,
                                   Low::Util::Handle p_Observed,
                                   Low::Util::Name p_Observable)
      {
        SphereCollider l_SphereCollider = p_Observer.get_id();
        l_SphereCollider.notify(p_Observed, p_Observable);
      }

      Low::Math::Vector3 SphereCollider::get_center() const
      {
        _LOW_ASSERT(is_alive());
        ...
        return TYPE_SOA(SphereCollider, center, Low::Math::Vector3);
      }
      void SphereCollider::set_center(float p_X, float p_Y, float p_Z)
      {
        Low::Math::Vector3 p_Val(p_X, p_Y, p_Z);
        set_center(p_Val);
      }

      void SphereCollider::set_center_x(float p_Value)
      {
      ...
      void SphereCollider::set_center_y(float p_Value)
      {
        Low::Math::Vector3 l_Value = get_center();
        l_Value.y = p_Value;
        set_center(l_Value);
      ...
      void SphereCollider::set_center_z(float p_Value)
      {
        Low::Math::Vector3 l_Value = get_center();
        l_Value.z = p_Value;
        set_center(l_Value);
      ...
      void SphereCollider::set_center(Low::Math::Vector3 p_Value)
      {
        _LOW_ASSERT(is_alive());
        ...
        if (get_center() != p_Value) {
          ...
          // Set new value
          TYPE_SOA(SphereCollider, center, Low::Math::Vector3) =
              p_Value;
          {
      ...
      float SphereCollider::get_radius() const
      {
        ...
        return TYPE_SOA(SphereCollider, radius, float);
      }
      void SphereCollider::set_radius(float p_Value)
      {
        _LOW_ASSERT(is_alive());
        ...
        if (get_radius() != p_Value) {
          ...
          // Set new value
          TYPE_SOA(SphereCollider, radius, float) = p_Value;
          {
            Low::Core::Entity l_Entity = get_entity();
            if (l_Entity.has_component(
                    Low::Core::Component::PrefabInstance::
      ...
      bool SphereCollider::is_trigger() const
      {
        ...
        return TYPE_SOA(SphereCollider, trigger, bool);
      }
      void SphereCollider::toggle_trigger()
      {
        set_trigger(!is_trigger());
      }

      void SphereCollider::set_trigger(bool p_Value)
      {
        _LOW_ASSERT(is_alive());
      ...
      Low::Core::Physics::Shape SphereCollider::get_shape() const
      {
        ...
        return TYPE_SOA(SphereCollider, shape,
                        Low::Core::Physics::Shape);
      }
      void
      SphereCollider::set_shape(Low::Core::Physics::Shape p_Value)
      {
        _LOW_ASSERT(is_alive());
        ...
        // Set new value
        TYPE_SOA(SphereCollider, shape, Low::Core::Physics::Shape) =
            p_Value;
      ...
      Low::Core::Physics::Body SphereCollider::get_static_body() const
      {
        _LOW_ASSERT(is_alive());
        ...
        return TYPE_SOA(SphereCollider, static_body,
                        Low::Core::Physics::Body);
      }
      void SphereCollider::set_static_body(
          Low::Core::Physics::Body p_Value)
      {
        ...
        // Set new value
        TYPE_SOA(SphereCollider, static_body,
                 Low::Core::Physics::Body) = p_Value;
      ...
      bool SphereCollider::is_initialized() const
      {
        _LOW_ASSERT(is_alive());
        ...
        return TYPE_SOA(SphereCollider, initialized, bool);
      }
      void SphereCollider::toggle_initialized()
      {
        set_initialized(!is_initialized());
      }

      void SphereCollider::set_initialized(bool p_Value)
      {
        _LOW_ASSERT(is_alive());
        ...
        // Set new value
        TYPE_SOA(SphereCollider, initialized, bool) = p_Value;
      ...
      Low::Core::Entity SphereCollider::get_entity() const
      {
        _LOW_ASSERT(is_alive());
        ...
        return TYPE_SOA(SphereCollider, entity, Low::Core::Entity);
      }
      void SphereCollider::set_entity(Low::Core::Entity p_Value)
      {
        _LOW_ASSERT(is_alive());
        ...
        // Set new value
        TYPE_SOA(SphereCollider, entity, Low::Core::Entity) = p_Value;
      ...
      Low::Util::UniqueId SphereCollider::get_unique_id() const
      {
        _LOW_ASSERT(is_alive());
        ...
        return TYPE_SOA(SphereCollider, unique_id,
                        Low::Util::UniqueId);
      }
      void SphereCollider::set_unique_id(Low::Util::UniqueId p_Value)
      {
        _LOW_ASSERT(is_alive());
        ...
        // Set new value
        TYPE_SOA(SphereCollider, unique_id, Low::Util::UniqueId) =
            p_Value;
      ...
      bool SphereCollider::is_dirty() const
      {
        _LOW_ASSERT(is_alive());
        ...
        return TYPE_SOA(SphereCollider, dirty, bool);
      }
      void SphereCollider::toggle_dirty()
      {
        set_dirty(!is_dirty());
      }

      void SphereCollider::set_dirty(bool p_Value)
      {
        _LOW_ASSERT(is_alive());
        ...
        // Set new value
        TYPE_SOA(SphereCollider, dirty, bool) = p_Value;
      ...
      void SphereCollider::mark_dirty()
      {
        if (!is_dirty()) {
      ...
      void SphereCollider::rebuild()
      {
        ...
        Low::Core::Physics::World l_World =
            get_physics_world(get_entity());

        Low::Math::Shape l_Shape;
        l_Shape.type = Low::Math::ShapeType::SPHERE;
        l_Shape.sphere.position = get_center();
        l_Shape.sphere.radius = get_radius();
      ...
      uint32_t SphereCollider::create_instance(u32 &p_PageIndex,
                                               u32 &p_SlotIndex)
      {
        u32 l_Index = 0;
        u32 l_PageIndex = 0;
      ...
      u32 SphereCollider::create_page()
      {
        const u32 l_Capacity = get_capacity();
        LOW_ASSERT((l_Capacity + ms_PageSize) < LOW_UINT32_MAX,
                   "Could not increase capacity for SphereCollider.");

        Low::Util::Instances::Page *l_Page =
            new Low::Util::Instances::Page;
        Low::Util::Instances::initialize_page(
            l_Page, SphereCollider::Data::get_size(), ms_PageSize);
      ...
      bool SphereCollider::get_page_for_index(const u32 p_Index,
                                              u32 &p_PageIndex,
                                              u32 &p_SlotIndex)
      {
        if (p_Index >= get_capacity()) {
